<template>
    <div @click="select" class="flex items-center bg-neutral-800 hover:bg-violet-900/30 rounded-md space-x-2 px-3 py-2 shadow-md shadow-neutral-950 hover:shadow-violet-800/20 transition duration-500 ease-in-out" :class="{'bg-violet-900/30 ring-1 ring-violet-800/50': isSelected}">
